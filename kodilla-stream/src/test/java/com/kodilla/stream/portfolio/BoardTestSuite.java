...
public class BoardTestSuite {
    ...
    void testAddTaskListAverageWorkingOnTask(){
        ...
        //When
        List<TaskList> inProgresTask = new LinkedList<>();
        inProgresTask.add(new TaskList("In progress"));

        List<Task> collect = project.getTaskLists().stream()
                .filter(inProgresTask::contains)
